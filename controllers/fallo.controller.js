...
exports.getFalloById = async (req, res, next) => {  
  ...
  try{
    ...
    let regFallo = {
                  ...
                  "numero-interno":       leerFallo[0][0].id_interno,
                  ...
                  "urlApi":               null,
                  "descriptores":         null,
                  "texto-completo":       leerFallo[0][0].texto, 
                  "magistrados":          [],
...
exports.getFallos = async (req, res, next) => {  
  ...
  try{
    ...
    const [total] = await Fallos.get(publicacion_desde, publicacion_hasta, umod_desde, umod_hasta, fecha_umod, texto, tribunal, offset, limit, true);
    
    // Descriptores no paso pues los fallos no tienen descriptores.
    const [leerFallos] = await Fallos.get(publicacion_desde, publicacion_hasta, umod_desde, umod_hasta, fecha_umod, texto, tribunal, offset, limit, false);
